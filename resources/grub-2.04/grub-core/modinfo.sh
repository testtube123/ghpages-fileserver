...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Arch Linux 9.2.1+20200130-2) 9.2.1 20200130'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/9.2.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
